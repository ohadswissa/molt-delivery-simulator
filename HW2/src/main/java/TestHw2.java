...
public class TestHw2 {
    public static void main(String[] args) {
        ...
        // Expected: The minimum should still be "Sushi" as "Pizza" was removed and "Taco" has a higher priority number
        ...
        testResult(testResults, "Untouched Heap Size After Merging", String.valueOf(untouchedHeapSizeBeforeMerge), String.valueOf(untouchedHeap.getSize()));
        ...
        testResult(testResults, "Min Order with Same Priorities", "Ramen", samePriorityHeap.findMin().getOrderDescription());
        ...
        try {
            ...
            testResults.add("Fail: Insert Null - Expected: IllegalArgumentException, Actual: " + e.getClass().getSimpleName());
        }
        ...
        try {
            ...
            testResults.add("Fail: Delete from Empty Heap - Expected: IllegalArgumentException, Actual: " + e.getClass().getSimpleName());
        }
